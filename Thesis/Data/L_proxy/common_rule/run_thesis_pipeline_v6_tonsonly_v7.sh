...
###############################################################################
# Thesis pipeline: v6 tons-only L proxy + v3 raw-from-L LP + Model 1A v7
###############################################################################
...
LPROXY_BUILDER="$LPROXY_STRATEGY_DIR/Build_L_Proxy_CommonRule_v6_tonsonly.py"
...
M1A="$DESIGN_DIR/Model_1A_v7_quarterly_windows.py"
