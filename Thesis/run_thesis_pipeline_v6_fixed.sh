...
###############################################################################
# Thesis pipeline: v6 tons-only L proxy + v3 tons-only raw LP + fixed Model 1A
###############################################################################
...
LP_DIR="Data/LP"
LP_BUILD_DIR="$LP_DIR/raw_from_l_v3_tonsonly"
...
LP_RAW="$LP_DIR/Build_LP_Panel_raw_from_L_v3_tonsonly.py"

M1A="$DESIGN_DIR/Model_1A_v7_quarterly_windows_fixed.py"
M1A_LP_INPUT="Data/LP/raw_from_l_v3_tonsonly/LP_Panel.tsv"
...
###############################################################################
# 2) LP build: v3 raw throughput over new L
###############################################################################

stage "2) Build LP branch: raw_from_l_v3_tonsonly"
