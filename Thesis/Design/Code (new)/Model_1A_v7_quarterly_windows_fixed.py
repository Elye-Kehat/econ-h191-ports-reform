...
def resolve_lp_path(user_path: Optional[str]) -> Tuple[Path, str]:
    ...
    - the resolved Path
    - a short label explaining how it was resolved
    ...
    So resolve_lp_path must return a 2-tuple. The broken file still returned only
    a Path, which caused:
    ...
    candidates = [
        ...
        (Path("Data/LP/raw_from_l_v2/LP_Panel.tsv"), "raw_from_l_v2"),
    ...
    raise FileNotFoundError(
        ...
        "Pass --lp explicitly or create canonical Data/LP/LP_Panel.tsv."
    )
...
def main() -> None:
    ...
    manifest = {
        "script": "Model_1A_v7_quarterly_windows.py",
