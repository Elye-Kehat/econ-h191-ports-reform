...
def main() -> None:
    ...
    out_dir = root / "Design" / "Output (new)" / "LP" / "Visuals_v3"
    ensure_dir(out_dir)
    ...
    out, meta = plot_group(
        ...
        ["haifa_port", "haifa_legacy", "haifa_bayport"],
        "Haifa LP series",
        out_dir / "plot_lp_haifa_all_v3.png",
        "Haifa",
    ...
    out, meta = plot_group(
        ...
        ["ashdod_port", "ashdod_legacy", "ashdod_hct"],
        "Ashdod LP series",
        out_dir / "plot_lp_ashdod_all_v3.png",
        "Ashdod",
        legend_loc="upper left",
    )
    if out is not None:
    ...
    out, meta = plot_group(
        ...
        "All main LP series",
        out_dir / "plot_lp_all_series_v3.png",
        "All",
        legend_loc="upper left",
    )
    if out is not None:
    ...
    with open(out_dir / "lp_visual_manifest_v3.json", "w", encoding="utf-8") as f:
