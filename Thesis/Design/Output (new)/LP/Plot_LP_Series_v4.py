...
# 1b. Ashdod-Legacy is aligned to start in the same quarter as Ashdod-HCT for the raw comparison plot.
...
TERMINAL_START = {
    ...
    "ashdod_legacy": pd.Timestamp(2022, 11, 1),
}
...
COLOR = {
    "haifa_port": "#1f77b4",
    "haifa_legacy": "#ff7f0e",
    "haifa_bayport": "#2ca02c",
    "ashdod_port": "#1f77b4",
    "ashdod_legacy": "#ff7f0e",
    "ashdod_hct": "#2ca02c",
}
...
def main() -> None:
    ...
    out_dir = root / "Design" / "Output (new)" / "LP" / "Visuals_v4"
    ensure_dir(out_dir)
    ...
    out, meta = plot_group(
        ...
        ["haifa_port", "haifa_legacy", "haifa_bayport"],
        "Haifa LP series",
        out_dir / "plot_lp_haifa_all_v4.png",
        "Haifa",
    ...
    out, meta = plot_group(
        ...
        ["ashdod_port", "ashdod_legacy", "ashdod_hct"],
        "Ashdod LP series",
        out_dir / "plot_lp_ashdod_all_v4.png",
        "Ashdod",
        legend_loc="upper left",
    )
    if out is not None:
    ...
    out, meta = plot_group(
        ...
        "All main LP series",
        out_dir / "plot_lp_all_series_v4.png",
        "All",
        legend_loc="upper left",
    )
    if out is not None:
    ...
    manifest = {
        ...
        "changes": [
            ...
            "Clipped Ashdod-Legacy to start at 2022-11-01 so Ashdod terminal comparison begins in the same quarter as HCT",
            "Applied explicit colors to match the settled LP figure convention: total = blue, legacy = orange, entrant = green",
    ...
    with open(out_dir / "lp_visual_manifest_v4.json", "w", encoding="utf-8") as f:
